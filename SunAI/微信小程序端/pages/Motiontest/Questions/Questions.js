...
Page({
  ...
  **/
  ...
  getQuestions: function (e) {
    ...
    var point=e.currentTarget.dataset.anscore;
    ...
    if (qu == 0) {
      ...
      var newanswer = { question_id: that.data.questions.question_id, answer_data: anmessage,answer_point:point };
    ...
    if (qu >= aa - 1) {
      wx.request({
        url: app.globalData.oldurl + 'add_answer?id=' + app.globalData.user_id+'&type='+app.globalData.type,
        ...
        success: (result) => {
          ...
          app.globalData.point=app.globalData.point+10
