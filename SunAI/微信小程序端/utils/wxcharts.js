...
var config = {
    ...
    colors: ['#ff4400', '#f7a35c', '#434348', '#90ed7d', '#f15c80', '#8085e9'],
    ...
    if (shape === 'diamond') {
        ...
        points.forEach(function (item, index) {
            if (item !== null) {
                ...
                context.arc(item.x, item.y, 4, 0, 2 * Math.PI);
            }
        });
    } else if (shape === 'rect') {
        points.forEach(function (item, index) {
...
function drawPointText(points, series, config, context) {
    ...
    points.forEach(function (item, index) {
        if (item !== null) {
            ...
            context.fillText(formatVal, item.x - measureText(formatVal) / 2, item.y - 10);
        }
    });
    context.closePath();
    context.stroke();
